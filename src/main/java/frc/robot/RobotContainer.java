...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.setDefaultOption("middle", Autos.middleAuto(driveSubsystem, ballSubsystem));
    autoChooser.addOption("left auto", Autos.leftAuto(driveSubsystem, ballSubsystem));
    autoChooser.addOption("right auto", Autos.rightAuto(driveSubsystem, ballSubsystem));
    autoChooser.addOption("drive auto", Autos.driveAuto(driveSubsystem, ballSubsystem));
